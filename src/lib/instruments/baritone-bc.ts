...
export const baritoneBC: Instrument = {
    ...
    transposition: "C",
    fingerings: [
      { note: "E2/Fb2", positions: ["1-2-3"], keys: ['v1', 'v2', 'v3'] },
      { note: "F2/E#2", positions: ["1-3"], keys: ['v1', 'v3'] },
      ...
      { note: "B2/Cb3", positions: ["1-2-3"], keys: ['v1', 'v2', 'v3'] },
      { note: "C3/B#2", positions: ["1-3"], keys: ['v1', 'v3'] },
      { note: "C#3/Db3", positions: ["2-3"], keys: ['v2', 'v3'] },
      { note: "D3", positions: ["1-2"], keys: ['v1', 'v2'] },
      ...
      { note: "B3/Cb4", positions: ["1-2"], keys: ['v1', 'v2'] },
      { note: "C4/B#3", positions: ["1"], keys: ['v1'] },
      { note: "C#4/Db4", positions: ["2"], keys: ['v2'] },
      { note: "D4", positions: ["Open"], keys: [] },
      { note: "D#4/Eb4", positions: ["1"], keys: ['v1'] },
      { note: "E4/Fb4", positions: ["2"], keys: ['v2'] },
      { note: "F4/E#4", positions: ["Open"], keys: [] },
      { note: "F#4/Gb4", positions: ["2-3"], keys: ['v2', 'v3'] },
      { note: "G4", positions: ["1-2"], keys: ['v1', 'v2'] },
      { note: "G#4/Ab4", positions: ["1"], keys: ['v1'] },
      { note: "A4", positions: ["2"], keys: ['v2'] },
      { note: "A#4/Bb4", positions: ["Open"], keys: [] },
    ],
