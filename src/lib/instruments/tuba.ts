...
export const tuba: Instrument = {
    ...
    transposition: "C",
    fingerings: [
      { note: "E1/Fb1", positions: ["1-2-3"], keys: ['v1', 'v2', 'v3'] },
      { note: "F1/E#1", positions: ["1-3"], keys: ['v1', 'v3'] },
      { note: "F#1/Gb1", positions: ["2-3"], keys: ['v2', 'v3'] },
      { note: "G1", positions: ["1-2"], keys: ['v1', 'v2'] },
      { note: "G#1/Ab1", positions: ["1"], keys: ['v1'] },
      { note: "A1", positions: ["2"], keys: ['v2'] },
      { note: "A#1/Bb1", positions: ["Open"], keys: [] },
      { note: "B1/Cb2", positions: ["1-2-3"], keys: ['v1', 'v2', 'v3'] },
      { note: "C2/B#1", positions: ["1-3"], keys: ['v1', 'v3'] },
      { note: "C#2/Db2", positions: ["2-3"], keys: ['v2', 'v3'] },
      { note: "D2", positions: ["1-2"], keys: ['v1', 'v2'] },
      { note: "D#2/Eb2", positions: ["1"], keys: ['v1'] },
      { note: "E2/Fb2", positions: ["2"], keys: ['v2'] },
      { note: "F2/E#2", positions: ["Open"], keys: [] },
      { note: "F#2/Gb2", positions: ["2-3"], keys: ['v2', 'v3'] },
      { note: "G2", positions: ["1-2"], keys: ['v1', 'v2'] },
      { note: "G#2/Ab2", positions: ["1"], keys: ['v1'] },
      { note: "A2", positions: ["2"], keys: ['v2'] },
      { note: "A#2/Bb2", positions: ["Open"], keys: [] },
      { note: "B2/Cb3", positions: ["1-2"], keys: ['v1', 'v2'] },
      { note: "C3/B#2", positions: ["1"], keys: ['v1'] },
      { note: "C#3/Db3", positions: ["2"], keys: ['v2'] },
      { note: "D3", positions: ["Open"], keys: [] },
      { note: "D#3/Eb3", positions: ["1"], keys: ['v1'] },
      { note: "E3/Fb3", positions: ["2"], keys: ['v2'] },
      { note: "F3/E#3", positions: ["Open"], keys: [] },
      { note: "F#3/Gb3", positions: ["2-3"], keys: ['v2', 'v3'] },
      { note: "G3", positions: ["1-2"], keys: ['v1', 'v2'] },
      { note: "G#3/Ab3", positions: ["1"], keys: ['v1'] },
      { note: "A3", positions: ["2"], keys: ['v2'] },
      { note: "A#3/Bb3", positions: ["Open"], keys: [] },
    ],
    range: { low: "E1", high: "A#3/Bb3", default: "Bb1" },
    setupGuide: [
      {
        title: "Assembly",
