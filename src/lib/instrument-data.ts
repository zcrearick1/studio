...
Carefully place each part back in its designated spot in the case.`
  ...
  },
  {
    ...
    clef: "treble",
    fingerings: [
      { note: "E3/Fb3", positions: ["Placeholder"] },
      { note: "F3/E#3", positions: ["Placeholder"] },
      { note: "F#3/Gb3", positions: ["Placeholder"] },
      { note: "G3", positions: ["Placeholder"] },
      { note: "G#3/Ab3", positions: ["Placeholder"] },
      { note: "A3", positions: ["Placeholder"] },
      { note: "A#3/Bb3", positions: ["Placeholder"] },
      { note: "B3/Cb4", positions: ["Placeholder"] },
      { note: "C4/B#3", positions: ["Placeholder"] },
      { note: "C#4/Db4", positions: ["Placeholder"] },
      { note: "D4", positions: ["Placeholder"] },
      { note: "D#4/Eb4", positions: ["Placeholder"] },
      { note: "E4/Fb4", positions: ["Placeholder"] },
      { note: "F4/E#4", positions: ["Placeholder"] },
      { note: "F#4/Gb4", positions: ["Placeholder"] },
      { note: "G4", positions: ["Placeholder"] },
      { note: "G#4/Ab4", positions: ["Placeholder"] },
      { note: "A4", positions: ["Placeholder"] },
      { note: "A#4/Bb4", positions: ["Placeholder"] },
      { note: "B4/Cb5", positions: ["Placeholder"] },
      { note: "C5/B#4", positions: ["Placeholder"] },
      { note: "C#5/Db5", positions: ["Placeholder"] },
      { note: "D5", positions: ["Placeholder"] },
      { note: "D#5/Eb5", positions: ["Placeholder"] },
      { note: "E5/Fb5", positions: ["Placeholder"] },
      { note: "F5/E#5", positions: ["Placeholder"] },
      { note: "F#5/Gb5", positions: ["Placeholder"] },
      { note: "G5", positions: ["Placeholder"] },
      { note: "G#5/Ab5", positions: ["Placeholder"] },
      { note: "A5", positions: ["Placeholder"] },
      { note: "A#5/Bb5", positions: ["Placeholder"] },
      { note: "B5/Cb6", positions: ["Placeholder"] },
      { note: "C6/B#5", positions: ["Placeholder"] },
      { note: "C#6/Db6", positions: ["Placeholder"] },
      { note: "D6", positions: ["Placeholder"] },
      { note: "D#6/Eb6", positions: ["Placeholder"] },
      { note: "E6/Fb6", positions: ["Placeholder"] },
      { note: "F6/E#6", positions: ["Placeholder"] },
      { note: "F#6/Gb6", positions: ["Placeholder"] },
      { note: "G6", positions: ["Placeholder"] }
    ],
...
Wipe down the exterior. Place the end cap on the top of the body before putting it in the case to protect the octave key mechanism.`
  ...
  },
  {
    ...
    clef: "treble",
    fingerings: [
      { note: "C3/B#2", positions: ["Placeholder"] },
      { note: "C#3/Db3", positions: ["Placeholder"] },
      { note: "D3", positions: ["Placeholder"] },
      { note: "D#3/Eb3", positions: ["Placeholder"] },
      { note: "E3/Fb3", positions: ["Placeholder"] },
      { note: "F3/E#3", positions: ["Placeholder"] },
      { note: "F#3/Gb3", positions: ["Placeholder"] },
      { note: "G3", positions: ["Placeholder"] },
...
Store the trumpet and mouthpiece in the case. Give your trumpet a full bath every few months to clean it inside and out.`
  ...
  },
   {
    ...
    clef: "bass",
    fingerings: [
      { note: "E2/Fb2", positions: ["Placeholder"] },
      { note: "F2/E#2", positions: ["Placeholder"] },
      { note: "F#2/Gb2", positions: ["Placeholder"] },
      { note: "G2", positions: ["Placeholder"] },
      { note: "G#2/Ab2", positions: ["Placeholder"] },
      { note: "A2", positions: ["Placeholder"] },
      { note: "A#2/Bb2", positions: ["Placeholder"] },
      { note: "B2/Cb3", positions: ["Placeholder"] },
      { note: "C3/B#2", positions: ["Placeholder"] },
      { note: "C#3/Db3", positions: ["Placeholder"] },
      { note: "D3", positions: ["Placeholder"] },
      { note: "D#3/Eb3", positions: ["Placeholder"] },
...
Store the baritone and mouthpiece in their case.`
  ...
  },
  {
    ...
    clef: "bass",
    fingerings: [
      { note: "D1", positions: ["Placeholder"] },
      { note: "D#1/Eb1", positions: ["Placeholder"] },
      { note: "E1/Fb1", positions: ["Placeholder"] },
      { note: "F1/E#1", positions: ["Placeholder"] },
      { note: "F#1/Gb1", positions: ["Placeholder"] },
      { note: "G1", positions: ["Placeholder"] },
      { note: "G#1/Ab1", positions: ["Placeholder"] },
      { note: "A1", positions: ["Placeholder"] },
      { note: "A#1/Bb1", positions: ["Placeholder"] },
      { note: "B1/Cb2", positions: ["Placeholder"] },
      { note: "C2/B#1", positions: ["Placeholder"] },
      { note: "C#2/Db2", positions: ["Placeholder"] },
      { note: "D2", positions: ["Placeholder"] },
      { note: "D#2/Eb2", positions: ["Placeholder"] },
      { note: "E2/Fb2", positions: ["Placeholder"] },
      { note: "F2/E#2", positions: ["Placeholder"] },
      { note: "F#2/Gb2", positions: ["Placeholder"] },
      { note: "G2", positions: ["Placeholder"] },
...
Wipe down the exterior of the tuba to remove fingerprints.`
  ...
  },
  {
    ...
    fingerings: [
      ...
      { note: "F#6/Gb6", positions: ["Placeholder"] },
      { note: "G6", positions: ["Placeholder"] },
      { note: "G#6/Ab6", positions: ["Placeholder"] },
      { note: "A6", positions: ["Placeholder"] },
      { note: "A#6/Bb6", positions: ["Placeholder"] },
      { note: "B6/Cb7", positions: ["Placeholder"] },
      { note: "C7/B#6", positions: ["Placeholder"] },
      { note: "C#7/Db7", positions: ["Placeholder"] },
      { note: "D7", positions: ["Placeholder"] },
      { note: "D#7/Eb7", positions: ["Placeholder"] },
      { note: "E7/Fb7", positions: ["Placeholder"] }
    ],
