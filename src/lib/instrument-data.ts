...
export const instruments: Instrument[] = [
  {
    ...
    clef: "treble",
    fingerings: [
      // Low Register (Octave 1)
      { note: "C4", positions: ["T 123 | 123 C#"] },
      { note: "C#4", positions: ["T 123 | 123"] },
      { note: "Db4", positions: ["T 123 | 123"] },
      { note: "D4", positions: ["T 123 | 12- Eb"] },
      { note: "D#4", positions: ["T 123 | 1-3 Eb"] },
      { note: "Eb4", positions: ["T 123 | 1-3 Eb"] },
      { note: "E4/Fb4", positions: ["T 12- | 12- Eb"] },
      { note: "E#4/F4", positions: ["T 12- | 1-3"] },
      ...
      { note: "B6", positions: ["T 12- | 1-3 B trill"] },
      { note: "B#7", positions: ["- 1-- | 1-- D trill"] },
      { note: "Cb7", positions: ["T 12- | 1-3 B trill"] },
      { note: "C7", positions: ["- 1-- | 1-- D trill"] },
    ],
