...
Carefully place each part back in its designated spot in the case.`
  ...
  },
  {
    ...
    clef: "treble",
    fingerings: [
      { note: "E3/Fb3", positions: ["T 123 | 456 + Low E Key"] },
      { note: "F3/E#3", positions: ["T 123 | 456"] },
      { note: "F#3/Gb3", positions: ["T 123 | 45-"] },
      { note: "G3", positions: ["T 123 | 4--"] },
      { note: "G#3/Ab3", positions: ["T 123 | Ab"] },
      { note: "A3", positions: ["T 12 | ---"] },
      { note: "A#3/Bb3", positions: ["T 1 | ---"] },
      { note: "B3/Cb4", positions: ["T | --- + R"] },
      { note: "C4/B#3", positions: ["--- | --- + R"] },
      { note: "C#4/Db4", positions: ["T 123 | 45- + R"] },
      { note: "D4", positions: ["T 123 | 4-- + R"] },
      { note: "D#4/Eb4", positions: ["T 123 | Eb + R"] },
      { note: "E4/Fb4", positions: ["T 12 | --- + R"] },
      { note: "F4/E#4", positions: ["T 1 | --- + R"] },
      { note: "F#4/Gb4", positions: ["T -2 | --- + R"] },
      { note: "G4", positions: ["T | ---"] },
      { note: "G#4/Ab4", positions: ["T | 4--"] },
      { note: "A4", positions: ["1 | ---"] },
      { note: "A#4/Bb4", positions: ["1 | 4-- (Side)"] },
      { note: "B4/Cb5", positions: ["R T 123 | 456"] },
      { note: "C5/B#4", positions: ["R T 123 | 45-"] },
      { note: "C#5/Db5", positions: ["R T 123 | 4--"] },
      { note: "D5", positions: ["R T 123 | ---"] },
      { note: "D#5/Eb5", positions: ["R T 12 | ---"] },
      { note: "E5/Fb5", positions: ["R T 1 | ---"] },
      { note: "F5/E#5", positions: ["R T -23 | 456"] },
      { note: "F#5/Gb5", positions: ["R T -23 | 45-"] },
      { note: "G5", positions: ["R T -23 | 4--"] },
      { note: "G#5/Ab5", positions: ["R T -23 | ---"] },
      { note: "A5", positions: ["R T -2 | ---"] },
      { note: "A#5/Bb5", positions: ["R T A#"] },
      { note: "B5/Cb6", positions: ["R T 1 | 4--"] },
      { note: "C6/B#5", positions: ["R T 1 | Side C"] },
      { note: "C#6/Db6", positions: ["R | ---"] },
      { note: "D6", positions: ["R 123 | 45- C#"] },
      { note: "D#6/Eb6", positions: ["R 123 | 4-- C#"] },
      { note: "E6/Fb6", positions: ["R 12 | 456 C#"] },
      { note: "F6/E#6", positions: ["R 1 | 456 C#"] },
      { note: "F#6/Gb6", positions: ["R 1 | 45- C#"] },
      { note: "G6", positions: ["R 1 | 4-- C#"] }
    ],
...
Disassemble the pieces and place them in the case.`
  ...
  },
  {
    ...
    clef: "treble",
    fingerings: [
      { note: "A#3/Bb3", positions: ["L:1 | R:Bis + Low Bb"] },
      { note: "B3/Cb4", positions: ["L:1 | R:Low B"] },
      { note: "C4/B#3", positions: ["L:1 | R:Low C"] },
      { note: "C#4/Db4", positions: ["L:123 | R:456 + Low C#"] },
      { note: "D4", positions: ["L:123 | R:456"] },
      { note: "D#4/Eb4", positions: ["L:123 | R:456 + Eb Key"] },
      { note: "E4/Fb4", positions: ["L:123 | R:45-"] },
      { note: "F4/E#4", positions: ["L:123 | R:4--"] },
      { note: "F#4/Gb4", positions: ["L:123 | R:-5-"] },
      { note: "G4", positions: ["L:123 | R:---"] },
      { note: "G#4/Ab4", positions: ["L:123 + G# Key | R:---"] },
      { note: "A4", positions: ["L:12 | R:---"] },
      { note: "A#4/Bb4", positions: ["L:1 + Bis | R:---"] },
      { note: "B4/Cb5", positions: ["L:1 | R:---"] },
      { note: "C5/B#4", positions: ["L:-2- | R:---"] },
      { note: "C#5/Db5", positions: ["L:--- | R:--- + Octave Key"] },
      { note: "D5", positions: ["L:123 | R:456 + Octave Key"] },
      { note: "D#5/Eb5", positions: ["L:123 | R:456 + Eb Key + Octave Key"] },
      { note: "E5/Fb5", positions: ["L:123 | R:45- + Octave Key"] },
      { note: "F5/E#5", positions: ["L:123 | R:4-- + Octave Key"] },
      { note: "F#5/Gb5", positions: ["L:123 | R:-5- + Octave Key"] },
      { note: "G5", positions: ["L:123 | R:--- + Octave Key"] },
      { note: "G#5/Ab5", positions: ["L:123 + G# Key | R:--- + Octave Key"] },
      { note: "A5", positions: ["L:12 | R:--- + Octave Key"] },
      { note: "A#5/Bb5", positions: ["L:1 + Bis | R:--- + Octave Key"] },
      { note: "B5/Cb6", positions: ["L:1 | R:--- + Octave Key"] },
      { note: "C6/B#5", positions: ["L:-2- | R:--- + Octave Key"] },
      { note: "C#6/Db6", positions: ["L:--- | R:--- + Octave Key"] },
      { note: "D6", positions: ["L:Palm D | R:--- + Octave Key"] },
      { note: "D#6/Eb6", positions: ["L:Palm D+Eb | R:--- + Octave Key"] },
      { note: "E6/Fb6", positions: ["L:Palm D+E | R:--- + Octave Key"] },
      { note: "F6/E#6", positions: ["L:Palm F | R:--- + Octave Key"] },
      { note: "F#6/Gb6", positions: ["L:1 | R:4-- + High F# Key"] }
    ],
...
Wipe down the exterior. Place the end cap on the top of the body before putting it in the case to protect the octave key mechanism.`
  ...
  },
  {
    ...
    clef: "treble",
    fingerings: [
        { note: "G#3/Ab3", positions: ["L:123 + G# Key | R:456 + Low C# Eb"] },
        { note: "A3", positions: ["L:123 + A Key | R:456"] },
        { note: "A#3/Bb3", positions: ["L:1 + Bis | R:Low Bb"] },
        { note: "B3/Cb4", positions: ["L:1 | R:Low B"] },
        { note: "C4/B#3", positions: ["L:1 | R:Low C"] },
        { note: "C#4/Db4", positions: ["L:123 | R:456 + Low C#"] },
        { note: "D4", positions: ["L:123 | R:456"] },
...
Wipe down the exterior. Place the end cap on the top of the body before putting it in the case to protect the octave key mechanism.`
  ...
  },
  {
    ...
    clef: "treble",
    fingerings: [
        { note: "A3/G##3", positions: ["L:1 | R:Low A"] },
        { note: "A#3/Bb3", positions: ["L:1 + Bis | R:Low Bb"] },
        { note: "B3/Cb4", positions: ["L:1 | R:Low B"] },
        { note: "C4/B#3", positions: ["L:1 | R:Low C"] },
        { note: "C#4/Db4", positions: ["L:123 | R:456 + Low C#"] },
