...
export const instruments: Instrument[] = [
  {
    ...
    fingerings: [
      ...
      { note: "C#4/Db4", positions: ["T 123 | 123"] },
      { note: "D4", positions: ["T 123 | 12- Eb"] },
      { note: "D#4/Eb4", positions: ["T 123 | 1-3 Eb"] },
      { note: "E4", positions: ["T 12- | 12- Eb"] },
      { note: "F4", positions: ["T 12- | 1-3"] },
