...
export function TrebleClefIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 56" width="50" height="100" {...props}>
      <path
        fill="currentColor"
        d="M11.9,4.3C9.1,4.3,6.8,6.1,6.8,8.4c0,2.3,2.3,4.1,5.1,4.1s5.1-1.8,5.1-4.1S14.7,4.3,11.9,4.3z M11.9,20.8c-2.8,0-5.1,1.8-5.1,4.1s2.3,4.1,5.1,4.1s5.1-1.8,5.1-4.1S14.7,20.8,11.9,20.8z M10.1,13.1L9.1,40.3l4.5,0.1l1.1-27.2H10.1z M10.1,41.9c-0.4,0-0.7,0.3-0.7,0.7v1.8c0,0.4,0.3,0.7,0.7,0.7h3.5c0.4,0,0.7-0.3,0.7-0.7v-1.8c0-0.4-0.3-0.7-0.7-0.7H10.1z M9.2,46.5c-1.3,0.3-2.4,1.3-2.4,2.6c0,1.6,1.4,2.9,3.3,2.9h4c1.8,0,3.3-1.3,3.3-2.9c0-1.3-1.1-2.3-2.4-2.6C18.2,45.4,20.8,42.2,20.8,38.2V16.7c0-3.6-2.4-6.6-5.6-7.9l-0.1-0.1v-0.1c2.4-1.2,4-3.5,4-6.2c0-1.4-1-2.5-2.3-2.5H8C7,0,5.9,1.1,5.9,2.5c0,2.7,1.6,5,4,6.2v0.1C6.7,10.1,4.2,13.1,4.2,16.7v21.5c0,4,2.7,7.2,6.1,8.3L9.2,46.5z"
      />
    </svg>
  );
}
